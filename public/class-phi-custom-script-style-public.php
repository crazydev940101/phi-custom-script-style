 ...
 * @subpackage Phi_Custom_Script_Style/public
 */
 ...
 */
class Phi_Custom_Script_Style_Public {
	...
	public function enqueue_styles() {
		...
		wp_enqueue_style( $this->plugin_name, plugin_dir_url( __FILE__ ) . 'css/phi-custom-script-style-public.css', array(), $this->version, 'all' );
